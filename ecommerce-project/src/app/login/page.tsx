  ...
  return (
    <div className="h-[calc(100vh - 80px)] px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 flex items-center justify-center">
      <form action="" className="flex flex-col gap-8">
        ...
        <button className="bg-specialPink text-white p-2 rounded-md disabled:bg-ping-200 disabled:cursor-not-allowed" disabled={isLoading}>{isLoading ? "Loading" : buttonTitle}</button>
